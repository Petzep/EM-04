/*
 * @brief Basic CMSIS include file for LPC11XXLV
 *
 * @note
...
#ifndef __CMSIS_11LVXX_H_
#define __CMSIS_11LVXX_H_
...
/** @defgroup CMSIS_11LVXX CHIP: LPC11LVxx CMSIS include file
 * @ingroup CHIP_11XX_CMSIS_Drivers
 * Applies to LPC1101LV, LPC1102LV, LPC1112LV, and LPC1114LV devices.
 * @{
 */
...
#error Incorrect or missing device variant (CHIP_LPC11XXLV)
#endif

/** @defgroup CMSIS_11LVXX_IRQ CHIP_11XXLV: CHIP_11XXLV peripheral interrupt numbers
 * @{
 */

typedef enum LPC11XXLV_IRQn {
...
/** @defgroup CMSIS_11LVXX_COMMON CHIP: LPC11LVxx Cortex CMSIS definitions
 * @{
 */
