/*
 * @brief Basic CMSIS include file for LPC1125
 *
 * @note
...
#ifndef __CMSIS_1125_H_
#define __CMSIS_1125_H_
...
/** @defgroup CMSIS_1125 CHIP: LPC1125 CMSIS include file
 * @ingroup CHIP_11XX_CMSIS_Drivers
 * Applies to LPC1125 device only.
 * @{
 */
...
#error Incorrect or missing device variant (CHIP_LPC1125)
#endif
