...
void Chip_ACMP_SetPosVoltRef(LPC_CMP_T *pACMP, CHIP_ACMP_POS_INPUT_T Posinput)
{
...
void Chip_ACMP_SetNegVoltRef(LPC_CMP_T *pACMP, CHIP_ACMP_NEG_INPUT_T Neginput)
{
