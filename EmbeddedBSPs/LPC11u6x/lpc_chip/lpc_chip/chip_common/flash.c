...
uint8_t Chip_FLASH_ReadBootCode()
{
	uint32_t command[5], result[4];
...
/* Reinvoke ISP */
uint8_t Chip_FLASH_ReinvokeISP()
{
	uint32_t command[5], result[4];
