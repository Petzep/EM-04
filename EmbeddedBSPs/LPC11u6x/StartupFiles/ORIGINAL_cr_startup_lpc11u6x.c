...
void __attribute__ ((weak)) USART1_4_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void USART1_4_IRQHandler();
	asm("bkpt 255");
}

void __attribute__ ((weak)) USART2_3_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void USART2_3_IRQHandler();
	asm("bkpt 255");
}

void __attribute__ ((weak)) SCT0_1_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void SCT0_1_IRQHandler();
	asm("bkpt 255");
}
...
void __attribute__ ((weak)) ADCA_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void ADCA_IRQHandler();
	asm("bkpt 255");
}
...
void __attribute__ ((weak)) BOD_WDT_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void BOD_WDT_IRQHandler();
	asm("bkpt 255");
}
...
void __attribute__ ((weak)) ADCB_IRQHandler() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void ADCB_IRQHandler();
	asm("bkpt 255");
}
