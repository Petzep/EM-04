...
void SlideMenu::setSpeed(int speed)
{
	m_speed = speed;
}

void SlideMenu::setAnimation(QEasingCurve::Type animationtype)
{
	m_animationtype = animationtype;
}

void SlideMenu::setVerticalMode(bool vertical)
{
	m_vertical = vertical;
}

void SlideMenu::setWrap(bool wrap)
{
	m_wrap = wrap;
}

void SlideMenu::slideInNext()
{
...
void SlideMenu::slideInIdx(int idx, t_direction direction)
{
...
void SlideMenu::animationDoneSlot(void)
{
...
void SlideMenu::slideInWgt(QWidget * newwidget, t_direction direction)
{
	if (m_active) {
